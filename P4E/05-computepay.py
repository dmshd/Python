...
to a number. Do not worry about error checking the user input unless you want
to - you can assume the user types numbers properly. Do not name your variable
...
def computepay(h,r):
	...
	rate = float(r)
	if hours > 40:
		hours_above_40 = hours - 40
		return str((hours * rate) + hours_above_40 * (rate / 2))
	else:
